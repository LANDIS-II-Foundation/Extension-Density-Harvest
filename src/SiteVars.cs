...
namespace Landis.Extension.DensityHarvest
{
    public class SiteVars
    {
        ...
        private static ISiteVar<Landis.Library.DensityCohorts.ISiteCohorts> cohorts;
        ...
        public static void Initialize()
        {
            ...
            cohorts = PlugIn.ModelCore.GetSiteVar<Landis.Library.DensityCohorts.ISiteCohorts>("Succession.DensityCohorts");
        ...
        {
            int maxAge = 0;
            foreach (ISpeciesCohorts sppCo in (Landis.Library.DensityCohorts.ISpeciesCohorts) SiteVars.Cohorts[site])
