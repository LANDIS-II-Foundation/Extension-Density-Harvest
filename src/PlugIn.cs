...
using HarvestMgmtLib = Landis.Library.DensityHarvestManagement;
...
namespace Landis.Extension.DensityHarvest
{
    ...
    {
        public static readonly string ExtensionName = "Density Harvest";
                                            ...
                                            ICore mCore)
        {
           ...
           // Landis.Library.BiomassHarvest.Main.InitializeLib(modelCore);
            ...
            HarvestMgmtLib.IInputParameters baseParameters = Landis.Data.Load<Landis.Library.DensityHarvestManagement.IInputParameters>(dataFile, parser);
            ...
            foreach (ManagementArea mgmtArea in managementAreas) {
                ...
                foreach (Stand stand in mgmtArea) {
                    ...
                    if (stand.Harvested && stand.LastPrescription.PreventEstablishment) {
                        ...
                        {
                            if (Library.DensitySiteHarvest.SiteVars.CohortsPartiallyDamaged[site] > 0 || HarvestMgmtLib.SiteVars.CohortsDamaged[site] > 0)
                            {
